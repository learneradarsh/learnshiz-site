...
export default function ClientsCarouselBand() {
  return (
    <section className="logo-cloud bg-slate-950/50 py-12 border-y border-slate-800/50 overflow-hidden">
      ...
      <div className="carousel-mask relative w-full overflow-hidden before:absolute before:left-0 before:top-0 before:z-10 before:h-full before:w-32 before:bg-gradient-to-r before:from-slate-950 before:to-transparent after:absolute after:right-0 after:top-0 after:z-10 after:h-full after:w-32 after:bg-gradient-to-l after:from-slate-950 after:to-transparent">
        <div className="carousel-track flex items-center w-max animate-[scroll-logos_44s_linear_infinite] hover:[animation-play-state:paused]">
          {[1, 2, 3].map((group) => (
            <div key={group} className="flex gap-[125px] shrink-0 items-center px-[62.5px]">
              ...
              <div className="logo-item flex items-center gap-3 shrink-0" style={{ color: "#8046FD" }}>
              ...
              <div className="logo-item flex items-center gap-3 shrink-0" style={{ color: "#2563EB" }}>
                <span className="logo-name font-bold text-xl tracking-wider">QUANTIX</span>
              </div>
              <div className="logo-item flex items-center gap-3 shrink-0 text-white">
                <span className="logo-icon">
              ...
              <div className="logo-item flex items-center gap-3 shrink-0">
                ...
                <span className="logo-name font-bold text-xl ml-2" style={{ background: "linear-gradient(135deg, #ff4c00 0%, #ff8300 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>LUMINA</span>
              </div>
              <div className="logo-item flex items-center gap-3 shrink-0" style={{ color: "#2563EB" }}>
