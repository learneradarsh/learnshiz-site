...
function App() {
  return (
    <div className="min-h-screen flex flex-col bg-white text-black" style={{fontFamily: 'Inter, ui-sans-serif, system-ui'}}>
      <style>{`
        :root { --primary: #f4511e; }
    ...
    <header className="shadow-sm">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md flex items-center justify-center text-white font-bold" style={{background: 'var(--primary)'}}>LS</div>
          <div>
            <div className="font-semibold">LearnShiz Techies</div>
            <div className="text-xs text-gray-600">Staffing & GCC Enablement</div>
          </div>
        </Link>
...
/* Minimal mobile menu with hamburger icon */
function MobileMenu(){
...
function Home(){
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-4xl font-extrabold leading-tight">Staffing & GCC Launch Partner for Global Companies</h1>
          <p className="mt-4 text-gray-700">LearnShiz Techies helps US and UK companies set up and scale Global Capability Centers (GCC) in India — from hiring to operations. We provide curated talent, compliance guidance, and local hiring expertise so your GCC performs from day one.</p>

          <div className="mt-6 flex gap-4">
            <Link to="/gcc" className="px-6 py-3 rounded-md text-white btn-primary font-medium shadow">Explore GCC Services</Link>
            <Link to="/contact" className="px-6 py-3 rounded-md border border-gray-300">Contact Sales</Link>
          </div>
        ...
        <div className="rounded-xl overflow-hidden shadow-lg">
          <div className="bg-gradient-to-br from-[var(--primary)] to-black p-10 text-white h-full flex items-center justify-center">
            <div className="space-y-4 max-w-sm">
              ...
              <Link to="/contact" className="inline-block mt-4 px-4 py-2 bg-white text-black rounded">Get Started</Link>
            </div>
          </div>
        </div>
      </div>
  ...
  <p className="mt-3 text-gray-700 max-w-xl">We are a staffing boutique specializing in technology talent and GCC enablement. Our leadership brings experience from enterprise hiring, operations, and engineering.</p>
  ...
  {/* Mission / Vision / Values — polished cards */}
  <div className="mt-8 grid md:grid-cols-3 gap-6">
    ...
    <InfoCard title="Values" text="Transparency • Speed • Quality • Partnership" icon="🤝" />
      ...
      {/* Clients + Testimonials carousels embedded on Home */}
      <div className="mt-12">
      <h2 className="text-3xl font-bold">Our Customers</h2>
      <p className="mt-3 text-gray-700">We partner with startups and enterprises from around the world.</p>
        <ClientsCarousel />
      </div>

      <div className="mt-12">
        <h2 className="text-3xl font-bold">What our customers say</h2>
        <p className="mt-3 text-gray-700">Real feedback from hiring managers and GCC leaders we've helped.</p>
        <div className="mt-8">
      ...
      {/* CTA before footer */}
      <div className="mt-16 bg-[var(--primary)] text-white rounded-md p-10 text-center">
        <h3 className="text-2xl font-bold">Ready to Accelerate Your Digital Journey with Us?</h3>
        <p className="mt-2">Let's talk — we help global companies build and scale high-performing GCCs in India.</p>
        <div className="mt-4">
          <Link to="/contact" className="inline-block px-6 py-3 rounded-md bg-white text-black font-medium">Get in touch</Link>
        </div>
      </div>
...
function StatCard({ value, label, accent=false }){
  return (
    <div className={`relative overflow-hidden rounded-xl p-6 text-center shadow-md transition-transform transform hover:-translate-y-1 ${accent ? 'bg-gradient-to-br from-[var(--primary)] to-black text-white' : 'bg-white'}`}>
      ...
      <div className={`${accent ? 'text-orange-100' : 'text-gray-600'} mt-2 text-sm`}>{label}</div>
    </div>
  );
}
...
/* ---------------- Simple pages (kept concise) ---------------- */
function Services(){
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <h2 className="text-3xl font-bold">Our Staffing Services</h2>
      <p className="mt-3 text-gray-700">Flexible engagement models to match your hiring needs.</p>
...
function GCC(){
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <p className="mt-3 text-gray-700">We help investors and enterprise engineering teams open GCCs in India: hiring strategy, infrastructure, compliance and ramp-up support.</p>
      ...
      <div className="mt-8 grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">US/UK product companies and startups that want a highly skilled delivery center with cost efficiency and time-zone overlap for engineering work.</p>
          </div>

          <div className="mt-6">
            <button onClick={() => navigate('/contact')} className="px-5 py-3 rounded-md btn-primary text-white font-medium">Talk to our GCC experts</button>
          </div>
        </div>
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <div className="flex items-center justify-between">
        ...
        <div>
          <Link to="/contact" className="px-4 py-2 bg-[var(--primary)] text-white rounded-md">Work with us</Link>
        </div>
      </div>
     ...
     {/* logo grid */}
          ...
          <div className="mt-4 space-y-4">
            <div className="p-4 border rounded-md bg-white shadow-sm">
              ...
              <div className="text-sm text-gray-600 mt-1">
                Scaled a 40-person engineering team in 4 months; improved release cycle time by 35% through targeted hires and onboarding.
              </div>
            </div>
            <div className="p-4 border rounded-md bg-white shadow-sm">
              <div className="font-semibold">FinTech — Offshore Delivery Center</div>
              <div className="text-sm text-gray-600 mt-1">
                Delivered compliance-focused engineers and established local payroll and statutory setup for smooth operations.
              </div>
            </div>
          </div>
      ...
      <div className="mt-12 p-6 bg-gray-50 rounded-md flex items-center justify-between">
        <div>
          ...
          <div className="text-sm text-gray-700 mt-1">Get a tailored proposal for hiring or GCC setup.</div>
        </div>
        <div>
          <Link to="/contact" className="px-4 py-2 rounded-md border">Request proposal</Link>
        </div>
      </div>
    </section>
  );
...
function Testimonials(){
  // Testimonials page uses the carousel component
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <h2 className="text-3xl font-bold">What our customers say</h2>
      <p className="mt-3 text-gray-700">Real feedback from hiring managers and GCC leaders we've helped.</p>
...
function Careers(){
  return (
    <section className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="mt-3 text-gray-700">We're hiring across engineering, recruiting, and GCC operations. Join a team focused on building great products and teams.</p>
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-700 mt-2">Growth focused culture, competitive compensation, and a chance to help global companies build world-class delivery centers in India.</p>
      </div>
    </section>
  );
}
      ...
      <div className="mt-8 grid md:grid-cols-3 gap-6">
        <div>
          ...
          <p className="text-gray-700 mt-2">
            Enable global companies to build successful delivery centers in India with minimal friction — delivering skilled talent, operational excellence and measurable outcomes.
          </p>
        </div>
        <div>
          <h4 className="font-semibold">Our Vision</h4>
          <p className="text-gray-700 mt-2">
            Become the most trusted partner for GCC hiring and operations in India, known for speed, quality and partnership.
          </p>
        </div>
        <div>
          <h4 className="font-semibold">Our Values</h4>
          <p className="text-gray-700 mt-2">Transparency • Speed • Quality • Partnership</p>
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 bg-white rounded shadow-sm text-center">
            ...
            <div className="text-sm text-gray-600">Professionals hired</div>
          </div>
          <div className="p-4 bg-white rounded shadow-sm text-center">
            <div className="font-bold text-xl">12+</div>
            <div className="text-sm text-gray-600">GCCs established</div>
          </div>
          <div className="p-4 bg-white rounded shadow-sm text-center">
            <div className="font-bold text-xl">12k+</div>
            <div className="text-sm text-gray-600">Sq ft space managed</div>
          </div>
          <div className="p-4 bg-white rounded shadow-sm text-center">
            <div className="font-bold text-xl">$6M+</div>
            <div className="text-sm text-gray-600">Capital investment created</div>
          </div>
        </div>
      </div>
    ...
    <section className="max-w-3xl mx-auto px-6 py-16">
      ...
      <form className="mt-6 grid grid-cols-1 gap-4" onSubmit={(e) => { e.preventDefault(); window.location = "mailto:hello@learnshiz.com" }}>
        ...
        <div className="flex gap-4">
          <button type="submit" className="px-5 py-3 rounded-md btn-primary text-white">Send message</button>
          <Link to="/careers" className="px-5 py-3 rounded-md border">Careers</Link>
        </div>
      </form>
...
/* ---------------- Clients & Testimonials Carousels ---------------- */
        ...
        <div className="min-h-[140px] bg-white rounded-xl border shadow-sm p-6 flex flex-col justify-between transition-all duration-500 ease-in-out">
          ...
          <div className="mt-4 flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-500">{items[idx].role}</div>
            </div>
            <div className="flex gap-2">
              <button onClick={prev} className="p-2 rounded-md border bg-white hover:bg-gray-50" aria-label="Previous testimonial">
                ‹
              </button>
              <button onClick={next} className="p-2 rounded-md border bg-white hover:bg-gray-50" aria-label="Next testimonial">
                ›
              </button>
            </div>
          </div>
